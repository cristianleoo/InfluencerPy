...
# Attach the tool specification to the function
generate_image_stability.tool_name = TOOL_SPEC["name"]
generate_image_stability.tool_description = TOOL_SPEC["description"]
generate_image_stability.args_schema = TOOL_SPEC["inputSchema"]
